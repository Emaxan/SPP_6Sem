...
const userIsAuthenticatedDefaults = {
  authenticatedSelector: () => false,//state.auth.isAuthenticated,
...
export const userIsAdminRedirect = connectedRouterRedirect({
  ...
  authenticatedSelector: () => false,//state.auth.isAuthenticated && state.auth.userInfo.role === Role.ADMIN,
  wrapperDisplayName: 'UserIsAdmin',
});

const userIsNotAuthenticatedDefaults = {
  authenticatedSelector: () => true,//!state.auth.isAuthenticated,
